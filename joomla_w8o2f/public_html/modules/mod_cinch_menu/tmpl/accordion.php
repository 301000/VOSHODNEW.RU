...
include  "css" . DIRECTORY_SEPARATOR . 'styles-accordion.php';
$document->addStyleDeclaration( $style );
include "js" . DIRECTORY_SEPARATOR . "accordion.js.php";
	...
	for($i = 0; $i < count($menus); $i++){
		...
		switch ($menus[$i]->browserNav) :
			...
			case 2:
				...
				break;
		endswitch;
		$icon_menu = ($menus[$i]->menu_image != '')?'<img src='.JURI::base(true).DIRECTORY_SEPARATOR.$menus[$i]->menu_image.' alt="menu icon" />':'';
