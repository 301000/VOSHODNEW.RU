...
<div id="<?php echo $mod_prefix; ?>djtabs" class="djtabs <?php echo $params->get('class_theme_title'); ?><?php echo $params->get('truncate_titles','1')=='0' ? ' full-titles' : ''; ?>">
	<div class="tabs-wrapper<?php echo ($params->get('tabs_hidden',2)==1) ? ' tabs-hidden' : ''; ?>">
		...
		<div class="djtabs-title-wrapper">
			<div id="<?php echo $mod_prefix; ?>djtab<?php echo $tab_i; ?>" class="djtabs-title" data-tab-no="<?php echo $tab_i;?>" tabindex="0">            	
				<?php
	...
	<div class="djtabs-in-border">
		...
		<div class="djtabs-in">
			...
			<?php foreach($tabs as $tab){ ?>
				<?php $tab_i++; ?>
				<div class="djtabs-body djclear <?php echo $tab->type_cl; ?>" data-tab-no="<?php echo $tab_i;?>" tabindex="0">
