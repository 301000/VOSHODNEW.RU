...
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<article itemscope itemtype="http://schema.org/Article">
  	...
  	|| $params->get('show_hits') || $params->get('show_category') || $params->get('show_parent_category') || $params->get('show_author') || $assocParam || $icons); ?>
		...
		<?php	if ($params->get('access-view')): ?>
			...
			<?php if ($content_type=='video' || $content_type=='gallery'): ?>
			<div class="pull-none item-image article-image article-image-full <?php if ($content_type=='video' && $params->get('access-view') ): ?>affix-video<?php endif; ?>">
 ...
 <div class="caption"><span><?php echo $images->image_fulltext_caption;?></span></div>
 <?php endif; ?>
