...
if(version_compare(JVERSION,'4','ge')){
	$convert_thumb = explode("#", $ctm_thumbnail);
	$ctm_thumbnail = $convert_thumb[0];
}
if($context == 'iframe') {
...
$play_button = ' title="Play" id="ja-btn-play"><span class="fa fa-play"></span>';
...
if ($ctm_source == 'other') {
	...
	$img_thumb = ($ctm_thumbnail == '' ? '' : $ctm_thumbnail);
	echo $iframe;
