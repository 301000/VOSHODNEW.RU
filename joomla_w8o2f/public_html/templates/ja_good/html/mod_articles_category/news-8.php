...
?>
<div class="row ja-news ja-news-8 <?php echo $params->get ('moduleclass_sfx') ?>">
	...
	<?php if ($grouped) : ?>
		...
		<div class="ja-news-group">
			...
			<?php foreach ($group as $item) : ?>
				<div class="<?php if($count==1 || $count==2): echo 'news-big col-md-6'; elseif(($count-2)%4==1 && $count>2) : echo 'news-normal col-md-3 clear'; else: echo 'news-normal col-md-3'; endif; ?> clearfix">
