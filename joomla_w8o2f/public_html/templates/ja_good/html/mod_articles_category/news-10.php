...
?>
<div class="row ja-news ja-news-10 <?php echo $params->get ('moduleclass_sfx') ?>">
		...
		<div class="ja-news-group">
			...
			<div class="news-big-wrap row-flex">
				<?php foreach ($group as $item) : ?>
					<div class="<?php if($count==1): echo 'news-big col-md-8';elseif($count==2): echo 'news-big col-md-4'; elseif(($count-2)%4==1 && $count>2) : echo 'news-normal col-md-3 clear'; else: echo 'news-normal col-md-3'; endif; ?> clearfix">
						<div class="new-inner">
							<!-- Intro Image -->
							<?php if($count <= 2) :?>
								<?php
