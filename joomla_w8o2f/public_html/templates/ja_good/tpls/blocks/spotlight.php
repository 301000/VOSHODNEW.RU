...
<?php
  ...
  ?>
  <!-- SPOTLIGHT -->
  <div class="t3-spotlight cols-<?php echo $cols;?> t3-<?php echo $name, ' ', $addcls, ' ', T3_BASE_ROW_FLUID_PREFIX ?>">
    <?php
    foreach ($splparams as $i => $splparam):
      $param = (object)$splparam;
    ?>
      <div class="<?php echo $datas[$i] ?> <?php if (!$this->countModules($param->position)) echo 'hide'; ?><?php echo $childcls ?>">
