...
?><div class="mnwall_loader mas_loader" id="mnwall_loader_<?php echo $this->widgetID; ?>"> </div>
	...
	?><div class="mnwall_filters_sortings"><?php
		// Filters
			...
			?><div class="mnwall_iso_reset_cont">
					<div class="mnwall_iso_reset">
						<button class="btn-reset" id="mnwall_reset_<?php echo $this->widgetID; ?>">
							...
							<?php echo \JText::_('COM_MINITEKWALL_RESET');
							?></button>
					</div>
				</div>
			<?php
	...
	?><div id="mnwall_iso_container_<?php
		echo $this->widgetID; ?>" class="mnwall_iso_container" style="margin: -<?php
	...
	if (isset($this->pagination) && ($this->pagination == '1' || $this->pagination == '4')) {
		?><div class="mnwall_more_results <?php echo ($this->pagination == '4') ? 'mnw-infinite' : ''; ?>">
