...
class MasonryModel extends BaseDatabaseModel
{
	...
	{
		$options = new \MinitekWallLibPagination;
	...
	public function getItems($widgetID)
	{
		...
		// Get items
		$result = $this->source->getItems(false, $source_params, $startLimit, $pageLimit, $globalLimit);
	...
	public function getItemsAjax($widgetID)
	{
		$page = Factory::getApplication()->input->get('page', false, 'INT');
