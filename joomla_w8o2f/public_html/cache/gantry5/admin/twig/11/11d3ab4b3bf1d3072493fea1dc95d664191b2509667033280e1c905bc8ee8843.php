...
class __TwigTemplate_f0e337757ecb3edf734213d7e683f2e218d9a2b17ea7ceaa5c80a3cd989fa6f7 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "/home/c/cp42004/joomla_w8o2f/public_html/administrator/components/com_gantry5/templates/pages/configurations/page/atoms.html.twig");
    }
}
