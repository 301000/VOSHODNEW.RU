...
namespace Joomla\Component\MinitekWall\Administrator\View\Items;
...
/**
 * Items view class for Minitek Wall.
 *
 * @since  4.0.12
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(\JText::_('COM_MINITEKWALL_CUSTOM_ITEMS_TITLE'), 'pencil');
