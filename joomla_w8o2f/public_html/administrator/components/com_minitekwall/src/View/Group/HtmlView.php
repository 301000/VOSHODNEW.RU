...
namespace Joomla\Component\MinitekWall\Administrator\View\Group;
...
/**
 * Group view class for Minitek Wall.
 *
 * @since  4.0.12
 */
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = ContentHelper::getActions('com_minitekwall', 'group', $this->item->id);
