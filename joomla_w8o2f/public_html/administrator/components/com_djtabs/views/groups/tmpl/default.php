...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djtabs&view=groups');?>" method="post" name="adminForm" id="adminForm">
<div class="row-fluid">
					...
					<td align="center">
						...
						if($listOrder=='a.ordering'){
							$ordering = 'true'; ?>
								...
								<span><?php echo $this->pagination->orderDownIcon($i, count($this->items), true, 'groups.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
