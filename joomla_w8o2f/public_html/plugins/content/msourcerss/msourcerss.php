 ...
 * @since  1.0.0
 */
class PlgContentMSourceRSS extends JPlugin
{
	/**
	...
	function onWidgetPrepareSource()
	{
		$source = array();
		$source['type'] = 'rss';
		$source['title'] = JText::_('PLG_CONTENT_MSOURCERSS_SOURCE_TITLE');
		$source['image'] = JURI::root(true).'/plugins/content/msourcerss/images/icon.png';
